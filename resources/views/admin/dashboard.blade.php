        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">TỔNG LƯỢT YÊU THÍCH</div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-red hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">BÀI VIẾT ĐANG CHỜ</div>
        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                ...
                <div class="info-box bg-deep-purple hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">LƯỢT NGƯỜI DÙNG HÔM NAY</div>
                                ...
                                <tbody>
                                    @foreach($popular_posts as $key=>$post)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-primary waves-effect" target="{{ ($post->status==true) ? '_blank' : '' }}" href="{{ route('post.details',$post->slug) }}">Xem</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
