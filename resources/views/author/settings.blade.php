                ...
                <ul class="header-dropdown m-r--5">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="javascript:void(0);">Một số tùy chọn khác</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="home_only_icon_title">
                        <form method="POST" action="{{ route('author.profile.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="name" class="form-control" placeholder="Nhập tên của bạn" value="{{ Auth::user()->name }}">
                                </div>
                            </div>
                            <label for="email">Email :</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="email" placeholder="Nhập email của bạn" value="{{ Auth::user()->email }}">
                                </div>
                            </div>
